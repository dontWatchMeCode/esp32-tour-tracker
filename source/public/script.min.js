function init_dv(){update_dv(),document.getElementById("add-key").addEventListener("click",()=>{progress(1),fetch("/api/key",{method:"POST"}).then(function(t){update_dv()}).catch(function(t){console.log(t)})})}function timer_dv(){update_dv()}function update_dv(){const t=document.getElementById("output_tbl");let n="";fetch("/api/key",{method:"GET"}).then(t=>t.json()).then(t=>get_req=t).then(()=>{get_req.forEach((t,e)=>{n+=`<tr>
                    ...
                    </div>`}),t.innerHTML=n,listeners_fi(get_req),progress(0)}).catch(function(t){console.log(t)})}function listeners_fi(o){document.querySelectorAll(".rn-name-btn").forEach((t,e)=>{t.addEventListener("click",t=>{document.querySelectorAll(".accordion-btn").forEach(t=>{t.classList.contains("collapsed")||t.click()}),Swal.fire({title:"Namensänderung",input:"text",inputLabel:"Bitte geben sie ihren gewünschten Namen ein.",showCancelButton:!0,customClass:{confirmButton:"btn btn-danger m-2",cancelButton:"btn btn-outline-dark m-2"},buttonsStyling:!1,confirmButtonColor:"#3085d6",cancelButtonColor:"#d33",cancelButtonText:"Abbrechen",confirmButtonText:"Ändern",inputValidator:t=>{if(!t)return"Name kann nicht leer sein!"}}).then(t=>{t.isConfirmed&&(progress(1),fetch("/api/tours?id="+e+"&name="+t.value,{method:"PATCH"}).then(function(t){update_fi()}).catch(function(t){console.log(t)}))})})}),document.querySelectorAll(".accordion-btn").forEach((t,e)=>{const n=document.querySelectorAll(".speed_info")[e].querySelectorAll("span"),a=document.querySelectorAll(".temp_info")[e].querySelectorAll("span");t.addEventListener("click",t=>{"-"==n[0].innerHTML&&(loading_animation.on(),fetch("/api/tours?file="+o[e].file,{method:"GET"}).then(t=>t.json()).then(t=>get_req=t).then(function(t){n.forEach((t,e)=>{t.innerHTML=get_req[e]}),a.forEach((t,e)=>{t.innerHTML=get_req[e+3]}),loading_animation.off()}))})}),document.querySelectorAll(".open-element-btn").forEach((t,e)=>{t.addEventListener("click",t=>{window.open("/view/"+o[e].file,"_blank")})}),document.querySelectorAll(".del-element-btn").forEach((t,e)=>{t.addEventListener("click",t=>{Swal.fire({title:"Sind Sie sich sicher?",text:"Sie können dies nicht rückgängig machen!",icon:"warning",showCancelButton:!0,customClass:{confirmButton:"btn btn-danger m-2",cancelButton:"btn btn-outline-dark m-2"},buttonsStyling:!1,confirmButtonColor:"#3085d6",cancelButtonColor:"#d33",cancelButtonText:"Abbrechen",confirmButtonText:"Löschen"}).then(t=>{t.isConfirmed&&(progress(1),fetch("/api/tours?id="+e,{method:"DELETE"}).then(function(t){update_fi()}).catch(function(t){console.log(t)}))})})}),document.querySelectorAll(".textarea-notes").forEach((e,n)=>{e.addEventListener("blur",t=>{fetch("/api/tours?id="+n+"&notes="+e.value.replace(/\n/g,"%0A"),{method:"PATCH"}).then(function(t){}).catch(function(t){console.log(t)})})}),document.querySelectorAll(".download-element-btn").forEach((t,e)=>{t.addEventListener("click",t=>{console.log("download at: "+e)})})}-1!=window.location.href.indexOf("/devices")&&(init_dv(),setInterval(()=>{timer_dv()},3e4)),-1!=window.location.href.indexOf("/files")&&update_fi();const click_block={container:null,body:null,cssClass:"click_block",check:function(){null==this.body&&(this.body=document.getElementsByTagName("body")[0])},open:function(){return this.check(),this.isOpen()||(this.container=document.createElement("div"),this.container.setAttribute("id","click_block"),this.body.append(this.container),this.body.classList.add(this.cssClass)),this},close:function(){return this.check(),this.isOpen()&&(this.body.classList.remove(this.cssClass),this.container.remove()),this},isOpen:function(){return this.check(),this.body.classList.contains(this.cssClass)}},loading_animation={container:document.getElementById("loading"),on:function(){this.container.style.opacity="1"},off:function(){this.container.style.opacity="0"}};function progress(t){1==t?(click_block.open(),loading_animation.on()):(click_block.close(),loading_animation.off())}function initMap(){const t=chroma.scale(["blue","yellow","red"]);var e=new google.maps.Map(document.getElementById("map"),{zoom:18,center:new google.maps.LatLng(data_array[1][8],data_array[1][9]),mapTypeId:"terrain"});let n=0;for(i=1;i<data_array.length-2;i++)n<data_array[i][11]&&(n=data_array[i][11]);for(i=1;i<data_array.length-2;i++){var a=new google.maps.LatLng(data_array[i][8],data_array[i][9]),o=new google.maps.LatLng(data_array[i+1][8],data_array[i+1][9]),l=data_array[i][11];polyline=new google.maps.Polyline({path:[a,o],geodesic:!0,strokeColor:t(l/n).toString(),strokeOpacity:1,strokeWeight:2,map:e})}var d=document.getElementById("infoChart").getContext("2d");const s=new Chart(d,{type:"line",responsive:!0,data:{labels:[],datasets:[{label:"km/h",data:[],borderWidth:1,borderColor:["#58508d"],pointStyle:"line"},{label:"C",data:[],borderWidth:1,borderColor:["#ff6361"],pointStyle:"line"},{label:"H",data:[],borderWidth:1,borderColor:["#ffa600"],pointStyle:"line"}]},options:{scales:{y:{beginAtZero:!0,suggestedMax:50}},elements:{point:{radius:0}}}});d=document.getElementById("accChart").getContext("2d");const c=new Chart(d,{type:"line",responsive:!0,data:{labels:[],datasets:[{label:"x",data:[],borderWidth:1,borderColor:["#003f5c"],pointStyle:"line"},{label:"y",data:[],borderWidth:1,borderColor:["#58508d"],pointStyle:"line"},{label:"z",data:[],borderWidth:1,borderColor:["#bc5090"],pointStyle:"line"}]},options:{scales:{y:{beginAtZero:!0}},elements:{point:{radius:0}}}});d=document.getElementById("rotChart").getContext("2d");const r=new Chart(d,{type:"line",responsive:!0,data:{labels:[],datasets:[{label:"x",data:[],borderWidth:1,borderColor:["#003f5c"],pointStyle:"line"},{label:"y",data:[],borderWidth:1,borderColor:["#58508d"],pointStyle:"line"},{label:"z",data:[],borderWidth:1,borderColor:["#bc5090"],pointStyle:"line"}]},options:{scales:{y:{beginAtZero:!0}},elements:{point:{radius:0}}}});for(let t=1;t<data_array.length-2;t++)s.data.labels[t]=data_array[t][7].substring(0,5),s.data.datasets[0].data[t]=data_array[t][11],s.data.datasets[1].data[t]=data_array[t][6],s.data.datasets[2].data[t]=data_array[t][10],c.data.labels[t]=data_array[t][7].substring(0,5),c.data.datasets[0].data[t]=data_array[t][0],c.data.datasets[1].data[t]=data_array[t][1],c.data.datasets[2].data[t]=data_array[t][2],r.data.labels[t]=data_array[t][7].substring(0,5),r.data.datasets[0].data[t]=data_array[t][3],r.data.datasets[1].data[t]=data_array[t][4],r.data.datasets[2].data[t]=data_array[t][5];s.update(),c.update(),r.update(),document.querySelectorAll(".lb-open").forEach((t,e)=>{const n=document.querySelectorAll(".lb-container")[e],a=document.querySelectorAll(".lb-close")[e],o=document.querySelectorAll('[data-mdb-toggle="tooltip"]');t.addEventListener("click",t=>{n.style.visibility="visible",n.style.opacity="1",o.forEach(t=>{const e=mdb.Tooltip.getInstance(t);e.hide()})}),a.addEventListener("click",t=>{n.style.visibility="hidden",n.style.opacity="0"})}),document.addEventListener("keydown",function(t){"Escape"===t.key&&document.querySelectorAll(".lb-container").forEach((t,e)=>{t.style.visibility="hidden",t.style.opacity="0"})})}